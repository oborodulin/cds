...
if "%cmd_compile_mark%" EQU "true" (
	...
	%utils_dir%\fnr.exe --cl --dir "%abs_temp_dir%" --fileMask "*.txt"  --includeSubDirectories --find "Copyright (C) 2013, 2014 Oleg Borodulin (admin@bis.unimansys.com)" --replace "%copyright%"

	rem добавляем сведения о дате построения проекта
	%utils_dir%\fnr.exe --cl --dir "%abs_temp_dir%" --fileMask "*.txt"  --includeSubDirectories --find "13.07.2015" --replace "%DATE%"

	rem добавляем сведения о текущей версии проекта
	%utils_dir%\fnr.exe --cl --dir "%abs_temp_dir%" --fileMask "*.txt"  --includeSubDirectories --find "1.17.20150713.1" --replace "%productversion%"
...
if "%source_build%" EQU "true" (
	...
	%utils_dir%\fnr.exe --cl --dir "%abs_temp_dir%" --fileMask "*-src.cmd"  --includeSubDirectories --find "Copyright (C) 2013, 2014 Oleg Borodulin (admin@bis.unimansys.com)" --replace "%copyright%"

	%utils_dir%\fnr.exe --cl --dir "%abs_temp_dir%" --fileMask "*-src.cmd"  --includeSubDirectories --find "13.07.2015" --replace "%DATE%"

	%utils_dir%\fnr.exe --cl --dir "%abs_temp_dir%" --fileMask "*-src.cmd"  --includeSubDirectories --find "1.17.20150713.1" --replace "%productversion%"
